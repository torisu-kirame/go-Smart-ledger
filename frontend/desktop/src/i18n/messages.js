export const messages = {
  zh: {
    ...
    assistant: {
      title: 'AI 助手',
      subtitle: '基于本地大模型（Ollama 等）解答账本与记账问题；可选加载账本 RAG 上下文。',
      disabledHint: '请先在设置中启用 AI 并配置模型地址。',
  ...
  en: {
    ...
    assistant: {
      title: 'AI Assistant',
      subtitle: 'Chat with a local LLM (Ollama, etc.) about ledgers and accounting; optionally attach ledger RAG context.',
      disabledHint: 'Enable AI and configure the model endpoint in Settings first.',
